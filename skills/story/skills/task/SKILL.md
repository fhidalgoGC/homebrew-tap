...
1. Leer el template canónico de `references/task-entry-template.md` (relativo a la carpeta del skill: `~/.fremi/framework/skills/task/references/task-entry-template.md`).
