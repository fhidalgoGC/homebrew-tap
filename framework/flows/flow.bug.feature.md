...
> **Config operativa:** [`docs/frmwk/settings/config.bug.feature.yaml`](../settings/config.bug.feature.yaml)
...
- Template canónico: [`docs/frmwk/skills/feature/skills/bug/references/BG-template.md`](../skills/feature/skills/bug/references/BG-template.md)
