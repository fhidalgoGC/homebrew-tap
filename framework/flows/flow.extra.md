...
> **Config operativa:** [`~/.fremi/framework/settings/config.extra.core.yaml`](../settings/config.extra.core.yaml)
...
- Config operativa: [`config.extra.yaml`](../settings/config.extra.core.yaml)
