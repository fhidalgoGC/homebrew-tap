...
> **Config operativa:** [`docs/frmwk/skills/enabler/config.user.yaml`](../settings/config.enabler.yaml)
...
| Cambio en docs / metodología | `docs/frmwk/` directo (o `EX-NN` si se registra como work item) |
...
- Templates canónicos: `docs/frmwk/skills/enabler/skills/<sub>/references/`
