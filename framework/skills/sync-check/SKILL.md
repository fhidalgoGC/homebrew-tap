...
- Regla 12 (sync-back) en `docs/frmwk/rules/workflow.md`.
- Regla 17 (versionado + linaje) en `docs/frmwk/rules/workflow.md`.
- `docs/frmwk/settings/config.yaml` — master (versioning + phase_rules).
- `docs/frmwk/settings/config.<capa>.yaml` — 7 archivos per-capa.
- `docs/frmwk/settings/methodology.json` — nomenclatura y ubicaciones.
