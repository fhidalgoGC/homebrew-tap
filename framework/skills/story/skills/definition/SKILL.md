...
1. Leer `docs/frmwk/settings/methodology.json` (extraer `identifiers.criterion`, `identifiers.workflow_doc.items[name=definition]`).
2. Leer `docs/frmwk/settings/config.yaml` (`phase_rules.definition`).
...
- `docs/frmwk/settings/config.yaml → phase_rules.definition`.
- `docs/frmwk/rules/workflow.md` → Regla 5 (formato definition), Regla 6 (frontera BDD/SDD/Design).
