...
> **Doc CONDICIONAL.** Obligatorio cuando aplica al menos uno de los criterios declarados en `docs/frmwk/settings/config.yaml → conditional_rules.explore_when`. Omitir si no aplica (no crear placeholder vacío).
>
...
- Convenciones que aplican (referenciar `docs/frmwk/rules/*` o `docs/project/rules/*` si aplica).
