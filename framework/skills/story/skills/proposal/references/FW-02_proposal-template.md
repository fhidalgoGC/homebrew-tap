...
> **Doc CONDICIONAL.** Obligatorio cuando aplica al menos uno de los criterios declarados en `docs/frmwk/settings/config.yaml → conditional_rules.proposal_when`. Omitir si no aplica.
>
