...
> **Reglas específicas:** [`~/.fremi/framework/reverse-engineering/rules/reverse.md`](./rules/reverse.md) — Reglas 25–32.
...
| **Regla 25–32** (reglas específicas de reverse) | Ver [`~/.fremi/framework/reverse-engineering/rules/reverse.md`](./rules/reverse.md). |
...
- Reglas específicas de reverse: [`~/.fremi/framework/reverse-engineering/rules/reverse.md`](./rules/reverse.md).
- Config operativo: [`~/.fremi/framework/settings/config.reverse.core.yaml`](../settings/config.reverse.core.yaml).
- Skills: [`~/.fremi/framework/reverse-engineering/`](./).
- Pipelines: [`~/.fremi/framework/pipelines/`](../pipelines/) — buscar `pipeline.reverse.*.md`.
- Flow forward por capa: `~/.fremi/framework/artifacts/product/flow.md`, `~/.fremi/framework/artifacts/feature/flow.md`, `~/.fremi/framework/artifacts/story/flow.md`, etc.
