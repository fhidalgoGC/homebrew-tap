...
> **Config operativa:** [`~/.fremi/framework/artifacts/enabler/config.user.yaml`](./config.user.yaml)
> **Orquestador:** [`/fremi-enabler`](./SKILL.md)
...
| Cambio en docs / metodología | `~/.fremi/framework/` directo (o `EX-NN` si se registra como work item) |
