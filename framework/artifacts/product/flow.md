...
> **Config operativa:** [`~/.fremi/framework/artifacts/product/config.user.yaml`](./config.user.yaml)
> **Orquestador:** [`/fremi-product`](./SKILL.md)
...
- Índice general de flujos: [`workflow.md`](../../flows/workflow.md)
