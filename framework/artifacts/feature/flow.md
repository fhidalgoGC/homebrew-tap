...
> **Config operativa:** [`~/.fremi/framework/artifacts/feature/config.user.yaml`](./config.user.yaml)
> **Orquestador:** [`/fremi-feature`](./SKILL.md)
...
- **Ver flow completo**: [flow bug (feature)](./skills/bug/flow.md).
...
**Regla `feature_decisions_when`** (en `config.user.yaml`):
...
- Config operativa: [`config.user.yaml`](./config.user.yaml)
- Reglas duras: [`workflow.md`](../../rules/workflow.md)
- Flow de story dentro de esta feature: [flow story](../story/flow.md)
- Flow de bug de feature: [flow bug (feature)](./skills/bug/flow.md)
- Flow de enabler: [flow enabler](../enabler/flow.md)
