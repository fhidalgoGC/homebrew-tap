...
> **Doc VIVO** (Regla 13). Es el único archivo del workflow que muta durante la implementación. Se actualiza al arrancar/cerrar cada task (o vía hook `~/.fremi/framework/artifacts/story/hooks/sync-checkwork.sh`).
>
