...
> **Config operativa:** [`~/.fremi/framework/artifacts/story/config.user.yaml`](./config.user.yaml)
> **Orquestador:** [`/fremi-story`](./SKILL.md)
...
- **Ver flow completo**: [flow bug (story)](./skills/bug/flow.md).
...
- Flow feature (padre): [flow feature](../feature/flow.md)
- Flow bug de story: [flow bug (story)](./skills/bug/flow.md)
- Flow enabler: [flow enabler](../enabler/flow.md)
