# `~/.fremi/framework/commands/` — Comandos custom (alternativa a skills)
...
**Carpeta vacía.** Hoy el proyecto usa **skills** (`~/.fremi/framework/skills/`) para todo. Los comandos quedan disponibles como categoría aparte por si en el futuro aparecen atajos de bajo nivel.

---

## Diferencia con skills

| | Skill (`~/.fremi/framework/skills/<X>/SKILL.md`) | Comando (`~/.fremi/framework/commands/<X>.md`) |
|---|---|---|
...
1. Crear `~/.fremi/framework/commands/<nombre>.md` con instrucciones claras y cortas.
