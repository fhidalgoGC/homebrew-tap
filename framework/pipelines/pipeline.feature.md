...
Corre en modo **automático** la secuencia declarada en [`docs/frmwk/skills/feature/config.user.yaml → flow.sequence`](../skills/feature/config.user.yaml), con extensiones para sync-back automático a producto (Regla 12) y bump del plan padre (Regla 17).
...
- `docs/frmwk/settings/methodology.json` + `config.feature.yaml` existen y parsean.
...
- Config operativa: [`docs/frmwk/skills/feature/config.user.yaml`](../skills/feature/config.user.yaml)
- Reglas: [`docs/frmwk/rules/workflow.md`](../rules/workflow.md) — Reglas 1, 3b, 12, 17, 20.
- Flujo descriptivo: [`docs/frmwk/flows/flow.feature.md`](../flows/flow.feature.md)
