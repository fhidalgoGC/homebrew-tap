...
Corre en modo **automático** la secuencia declarada en [`docs/frmwk/skills/product/config.user.yaml → flow.sequence`](../skills/product/config.user.yaml).
...
- `docs/frmwk/settings/methodology.json` existe y parsea.
- `docs/frmwk/settings/config.yaml` + `config.product.yaml` existen y parsean.
...
- Config operativa: [`docs/frmwk/skills/product/config.user.yaml`](../skills/product/config.user.yaml)
- Reglas: [`docs/frmwk/rules/workflow.md`](../rules/workflow.md) — Reglas 3b, 4, 12, 17.
- Flujo descriptivo: [`docs/frmwk/flows/flow.product.md`](../flows/flow.product.md)
- Orquestador manual: [`/fremi-product`](../skills/product/SKILL.md)
- Sub-skills: `docs/frmwk/skills/product/skills/`
